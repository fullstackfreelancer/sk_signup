...
use SIMONKOEHLER\SkSignup\Controller\UserController;
use SIMONKOEHLER\SkSignup\Controller\SignupController;
...
$GLOBALS['TYPO3_CONF_VARS']['FE']['cacheHash']['excludedParameters'][] = 'tx_sksignup_default[action]';
$GLOBALS['TYPO3_CONF_VARS']['FE']['cacheHash']['excludedParameters'][] = 'tx_sksignup_default[key]';
